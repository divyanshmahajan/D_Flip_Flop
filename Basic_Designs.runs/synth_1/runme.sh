...
HD_PWD='D:/Digital Design Files/Basic_Designs/Basic_Designs.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log D_Flip_Flop.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source D_Flip_Flop.tcl
